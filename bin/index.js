...
server.registerTool(
  'auditPackage',
  {
    ...
    inputSchema: {
      projectRoot: z
        .string()
        .describe('本地需要安全审计工程的文件夹根路径，或者远程仓库的URL地址，例如["D:\\DATA\\Project\\ShopProject\\", "/Users/rexhang/DATA/Project/ShopProject/", "https://github.com/webpack/webpack-dev-server/tree/v4.9.3/"]'),
      savePath: z
        .string()
        .describe(
